...
Appium server (a preinstalled runner has no xcodebuild). It is reaped only
when that driver is reaped or none is alive; before 2026-09-24 every live
XCUITest session older than ten minutes died whenever another session started
or ended. On 2026-09-19/20 four booted simulators, three Metro bundlers and
